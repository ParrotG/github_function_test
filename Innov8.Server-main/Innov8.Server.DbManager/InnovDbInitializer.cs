...
internal class InnovDbInitializer(
  IServiceProvider serviceProvider,
  ILogger<InnovDbInitializer> logger)
  : BackgroundService
{
    ...
    CancellationToken cancellationToken)
  {
    ...
    var dbContext = scope.ServiceProvider.GetRequiredService<InnovDbContext>();

    await InitializeDatabaseAsync(dbContext, cancellationToken);
  }

  private async Task InitializeDatabaseAsync(InnovDbContext dbContext,
    CancellationToken cancellationToken)
  {
    using var activity = _activitySource.StartActivity(
      "Initializing catalog database",
      ActivityKind.Client);
  ...
  // private async Task
  private void SeedAsync(InnovDbContext dbContext,
    CancellationToken cancellationToken)
  {
